...
export default function Footer() {
  return (
    <footer className="bg-lingo-navy-dark text-white mt-auto">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-lingo-disabled text-sm leading-relaxed max-w-xs">
              Master real-world Chinese through mission-based learning, AI tutors, and human coaches.
            </p>
          </div>

          <div>
            <h3 className="text-sm font-semibold text-lingo-border uppercase tracking-wider mb-4">Learn</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold text-lingo-border uppercase tracking-wider mb-4">Company</h3>
            <ul className="space-y-2">
              {[
        ...
        <div className="border-t border-white/10 mt-10 pt-6 text-center text-sm text-lingo-disabled">
