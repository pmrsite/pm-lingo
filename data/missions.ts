    ...
    grammarNotes: [
      {
        ...
        explanation: '你好 literally means "you good" — it is the standard everyday greeting in Mandarin for any time of day.',
      },
      {
        simplified: '您好',
        traditional: '您好',
        ...
        explanation: '您好 uses 您 (nín), the formal/respectful form of "you". Use it with elders, bosses, or customers.',
      },
      {
        simplified: '吗',
        traditional: '嗎',
        ...
        explanation: '你好吗？ adds the question particle 吗 (ma) to turn a statement into a yes/no question. Place 吗 at the end of any statement.',
      },
      {
        simplified: '你呢',
        traditional: '你呢',
        ...
        explanation: '呢 (ne) is a particle meaning "and what about...?" — 你呢 means "And you?" or "What about you?" Use it to bounce a question back.',
      },
      {
        simplified: '我也很好',
        traditional: '我也很好',
        ...
        title: '"Also / too" — 也 (yě)',
        explanation: '也 (yě) means "also" or "too". 我也很好 = "I am also very well". Place 也 directly before the verb or adjective.',
      },
    ],
    regionalNotes: [
    ...
    grammarNotes: [
      {
        ...
        explanation: '我叫 literally means "I am called" and is the most natural way to give your name in Mandarin. Follow directly with your name.',
      },
      {
        simplified: '我是',
        traditional: '我是',
        ...
        explanation: '我是 means "I am" and is used for nationality, profession, and identity statements. 是 is the Mandarin verb "to be".',
      },
      {
        simplified: '什么',
        traditional: '什麼',
        ...
        explanation: '什么 (shénme) means "what". 你叫什么名字 = "What are you called?" — literally "You called what name?"',
      },
      {
        simplified: '马来西亚人',
        traditional: '馬來西亞人',
        ...
        explanation: 'To express nationality, add 人 (rén, meaning "person") after the country name: 马来西亚 + 人 = 马来西亚人 (Malaysian).',
      },
      {
        simplified: '工作',
        traditional: '工作',
        ...
        explanation: '你做什么工作？ means "What work do you do?" — 做 (zuò) means "to do" and 工作 (gōngzuò) means "work/job".',
      },
    ],
    regionalNotes: [
    ...
    grammarNotes: [
      {
        ...
        explanation: '请问 literally means "May I ask" and is the standard polite way to start any question in Mandarin. It softens any request immediately.',
      },
      {
        simplified: '在哪里',
        traditional: '在哪裡',
        ...
        explanation: 'The pattern [place] 在哪里 means "Where is [place]?" — 洗手间在哪里 = "Where is the restroom?" Place the location first, then 在哪里.',
      },
      {
        simplified: '直走',
        traditional: '直走',
        pinyin: 'zhí zǒu',
        title: '"Go straight"',
        explanation: '直走 means "go straight". 直 (zhí) means "straight/direct" and 走 (zǒu) means "walk/go".',
      },
      {
        simplified: '然后',
        traditional: '然後',
        ...
        explanation: '然后 (rán hòu) means "then" or "after that". It links steps in directions: 直走，然后右边 = "Go straight, then turn right".',
      },
      {
        simplified: '对',
        traditional: '對',
        ...
        explanation: '对 (duì) means "correct" or "right" — you will hear it constantly as confirmation in conversation. It can stand alone as a one-word response.',
      },
    ],
    regionalNotes: [
    ...
    grammarNotes: [
      {
        ...
        explanation: '我要 means "I want/would like" and is the key phrase for ordering. It is direct but perfectly natural in a restaurant.',
      },
      {
        simplified: '一碗 / 一杯',
        traditional: '一碗 / 一杯',
        ...
        explanation: '一碗 (yì wǎn) = one bowl, 一杯 (yì bēi) = one cup/glass. Every noun in Chinese uses a specific measure word — 碗 for bowls, 杯 for cups and glasses.',
      },
      {
        simplified: '不',
        traditional: '不',
        pinyin: 'bù',
        title: 'Negation — "not"',
        explanation: '不 (bù) is the negation word. Add 不 before any adjective to negate it: 辣 (là) = spicy → 不辣 = not spicy.',
      },
      {
        simplified: '还要',
        traditional: '還要',
        ...
        explanation: '还要 (hái yào) means "also want". Use it to add items to your order: 还要一杯水 = "Also a glass of water".',
      },
      {
        simplified: '买单',
        traditional: '買單',
        ...
        explanation: '买单 literally means "buy the bill" and is the standard way to ask for the check. You can also wave and say it to a waiter across the room.',
      },
    ],
    regionalNotes: [
    ...
    grammarNotes: [
      {
        ...
        explanation: '我要去 + destination is the core taxi phrase meaning "I want to go to [place]". Add any destination after 去.',
      },
      {
        simplified: '打表',
        traditional: '打表',
        ...
        explanation: '打表 (dǎ biǎo) means "use the meter". Always say this when getting into a taxi to avoid negotiated (often inflated) prices.',
      },
      {
        simplified: '大概',
        traditional: '大概',
        ...
        explanation: '大概 (dàgài) means "approximately" or "roughly" — very useful for getting price or time estimates.',
      },
      {
        simplified: '左右',
        traditional: '左右',
        ...
        explanation: '左右 (zuǒyòu) means "around" or "more or less" when used after a number. 八十块左右 = "around 80 yuan".',
      },
      {
        simplified: '停',
        traditional: '停',
        pinyin: 'tíng',
        title: '"Stop"',
        explanation: '停 (tíng) is a single powerful word meaning "stop". Use it clearly when you need the driver to pull over.',
      },
    ],
    regionalNotes: [
